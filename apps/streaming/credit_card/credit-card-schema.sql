...
IF NOT EXISTS CC_TRANS_BRIDGE(CC_TRANS STRING, CCN STRING , TRANS_TS TIMESTAMP, MCC INT , MRCH_ID
  STRING , STATE STRING , AMNT DOUBLE) PARTITIONED BY(PROCESSING_CYCLE STRING) ROW FORMAT DELIMITED
...
INSERT OVERWRITE STATE FROM SELECT ST, STATE FROM STATE_RAW;    